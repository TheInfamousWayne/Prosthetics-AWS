...
class CriticNetwork:
    ...
    def __init__(self,sess,state_dim,action_dim):
        ...
        self.sess = sess
        # create q network
        self.state_input,        self.action_input,        self.q_value_output,        self.params,        self.is_training = self.create_q_network(state_dim,action_dim)
        # create target q network (the same structure with q network)
        self.target_state_input,        self.target_action_input,        self.target_q_value_output,        self.target_update,        self.target_is_training = self.create_target_q_network(state_dim,action_dim,self.params)
    ...
    def create_training_method(self):
        ...
        weight_decay = tf.add_n([L2 * tf.nn.l2_loss(var) for var in self.params])
    ...
    def create_q_network(self,state_dim,action_dim):
        ...
        W2_action = self.variable([action_dim,layer2_size],layer1_size+action_dim) # action input from actor network
